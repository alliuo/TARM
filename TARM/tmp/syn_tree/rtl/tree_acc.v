...
assign tmp_sum3 = ({pp_hh[1], pp_hl[3], pp_lh[3]} == 3'b000) ? 2'b00 : (
                  ...
                  ({pp_hh[1], pp_hl[3], pp_lh[3]} == 3'b111) ? 2'b11 : 2'b00)))))));
...
assign tmp_sum0 = ({pp_hl[0], pp_lh[0], pp_ll[2]} == 3'b000) ? 2'b00 : (
                  ...
                  ({pp_hl[0], pp_lh[0], pp_ll[2]} == 3'b111) ? 2'b11 : 2'b00)))))));           
...
assign {carry1, result[4]} = ({tmp_sum2[0], tmp_sum1[1], carry0} == 3'b000) ? 2'b00 : (
                               ...
                               ({tmp_sum2[0], tmp_sum1[1], carry0} == 3'b011) ? 2'b10 : (
                               ...
                               ({tmp_sum2[0], tmp_sum1[1], carry0} == 3'b111) ? 2'b11 : 2'b00)))))));
...
assign {carry2, result[5]} = ({tmp_sum3[0], tmp_sum2[1], carry1} == 3'b000) ? 2'b00 : (
                               ...
                               ({tmp_sum3[0], tmp_sum2[1], carry1} == 3'b011) ? 2'b10 : (
                               ...
                               ({tmp_sum3[0], tmp_sum2[1], carry1} == 3'b111) ? 2'b11 : 2'b00)))))));
