...
module tree_6 ( pp_hh, pp_hl, pp_lh, pp_ll, result );
  input [3:0] pp_hh;
  input [3:0] pp_hl;
  input [3:0] pp_lh;
  input [3:0] pp_ll;
  ...
  VHSR_OAI21_2 U35 ( .A1(pp_ll[2]), .A2(pp_lh[0]), .B(pp_hl[0]), .ZN(n37) );
  VHSR_OAI31_2 U36 ( .A1(pp_ll[2]), .A2(pp_lh[0]), .A3(pp_hl[0]), .B(n37), 
        .ZN(n21) );
