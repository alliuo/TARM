...
mul2_2 mul_hl_hl (.a(a[7:6]), .b(b[1:0]), .out(pp_hl_hl));
mul2_acc mul_hl_lh (.a(a[5:4]), .b(b[3:2]), .out(pp_hl_lh));
mul2_acc mul_hl_ll (.a(a[5:4]), .b(b[1:0]), .out(pp_hl_ll));
tree_3 tree_hl (.pp_hh(pp_hl_hh), .pp_hl(pp_hl_hl), .pp_lh(pp_hl_lh), .pp_ll(pp_hl_ll), .result(pp_hl));
...
tree_1 tree_ll (.pp_hh(pp_ll_hh), .pp_hl(pp_ll_hl), .pp_lh(pp_ll_lh), .pp_ll(pp_ll_ll), .result(pp_ll));
