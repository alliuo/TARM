...
module mul8_50 ( a, b, product );
  ...
  VHSR_INOR2_2 U237 ( .A1(n282), .B1(n248), .ZN(n250) );
  ...
  VHSR_NOR2_1 U244 ( .A1(n324), .A2(n364), .ZN(n446) );
  ...
  VHSR_INOR2_1 U249 ( .A1(n411), .B1(n410), .ZN(n413) );
  VHSR_INOR2_1 U250 ( .A1(n255), .B1(n294), .ZN(n283) );
  VHSR_CLKN_1 U251 ( .I(n388), .ZN(n380) );
  VHSR_INAND2_1 U252 ( .A1(n390), .B1(n379), .ZN(n388) );
  VHSR_INOR2_1 U253 ( .A1(n253), .B1(n299), .ZN(n296) );
  VHSR_INOR2_1 U254 ( .A1(n393), .B1(n370), .ZN(n392) );
  VHSR_INOR3_1 U255 ( .A1(b[7]), .B1(n453), .B2(n304), .ZN(n272) );
  VHSR_AD1_1 U256 ( .A(n432), .B(n450), .CI(n431), .CO(n428), .S(product[5])
         );
  VHSR_AD1_1 U257 ( .A(n427), .B(n426), .CI(n425), .CO(n422), .S(
        \intadd_0/SUM[3] ) );
  VHSR_AD1_1 U258 ( .A(n421), .B(n420), .CI(n419), .CO(n416), .S(product[10])
         );
  VHSR_AD1_1 U259 ( .A(n434), .B(n433), .CI(n457), .CO(n395), .S(product[3])
         );
  VHSR_AD1_1 U260 ( .A(n430), .B(n429), .CI(n428), .CO(n435), .S(product[6])
         );
  VHSR_AD1_1 U261 ( .A(n424), .B(n423), .CI(n422), .CO(n419), .S(product[9])
         );
  VHSR_AD1_1 U262 ( .A(n418), .B(n417), .CI(n416), .CO(n438), .S(
        \intadd_0/SUM[6] ) );
  VHSR_CLKNAND2_2 U263 ( .A1(b[0]), .A2(a[0]), .ZN(n364) );
  VHSR_CLKNAND2_2 U264 ( .A1(b[3]), .A2(a[7]), .ZN(n280) );
  VHSR_IN_2 U265 ( .I(b[3]), .ZN(n385) );
  VHSR_IN_2 U266 ( .I(a[6]), .ZN(n249) );
  VHSR_IN_2 U267 ( .I(a[7]), .ZN(n320) );
  VHSR_IN_2 U268 ( .I(b[2]), .ZN(n365) );
  VHSR_OAI22_2 U269 ( .A1(n385), .A2(n249), .B1(n320), .B2(n365), .ZN(n285) );
  VHSR_IN_2 U270 ( .I(a[4]), .ZN(n355) );
  VHSR_CLKNAND2_2 U271 ( .A1(b[3]), .A2(a[5]), .ZN(n246) );
  VHSR_IN_2 U272 ( .I(b[1]), .ZN(n456) );
  VHSR_OAI22_2 U273 ( .A1(n308), .A2(n246), .B1(n320), .B2(n456), .ZN(n254) );
  VHSR_IN_2 U274 ( .I(a[5]), .ZN(n351) );
  VHSR_NOR4_2 U275 ( .A1(n308), .A2(n280), .A3(n351), .A4(n456), .ZN(n247) );
  VHSR_AOI31_2 U276 ( .A1(b[2]), .A2(a[6]), .A3(n254), .B(n247), .ZN(n255) );
  ...
  VHSR_OAI22_2 U281 ( .A1(n320), .A2(n454), .B1(n249), .B2(n456), .ZN(n251) );
  VHSR_MAOI222_2 U282 ( .A(n313), .B(n250), .C(n251), .ZN(n253) );
  VHSR_NOR2_1 U283 ( .A1(n249), .A2(n454), .ZN(n307) );
  VHSR_AOI211_2 U284 ( .A1(a[4]), .A2(b[0]), .B(n351), .C(n456), .ZN(n306) );
  VHSR_MAOI222_2 U285 ( .A(n308), .B(n307), .C(n306), .ZN(n305) );
  VHSR_OR2_2 U286 ( .A1(n313), .A2(n250), .Z(n252) );
  VHSR_OAI21_2 U287 ( .A1(n252), .A2(n251), .B(n253), .ZN(n300) );
  VHSR_NOR2_1 U288 ( .A1(n305), .A2(n300), .ZN(n299) );
  VHSR_AOI32_2 U289 ( .A1(b[2]), .A2(n255), .A3(a[6]), .B1(n254), .B2(n255), 
        .ZN(n295) );
  VHSR_CLKNAND2_2 U290 ( .A1(n283), .A2(n282), .ZN(n281) );
  VHSR_CLKNAND2_2 U291 ( .A1(n285), .A2(n281), .ZN(n279) );
  VHSR_CLKNAND2_2 U292 ( .A1(b[6]), .A2(a[2]), .ZN(n260) );
  VHSR_CLKNAND2_2 U293 ( .A1(b[6]), .A2(a[0]), .ZN(n304) );
  VHSR_NAND3_2 U294 ( .A1(a[1]), .A2(b[7]), .A3(n304), .ZN(n262) );
  VHSR_CLKNAND2_2 U295 ( .A1(b[4]), .A2(a[2]), .ZN(n303) );
  VHSR_NAND3_2 U296 ( .A1(a[3]), .A2(b[5]), .A3(n303), .ZN(n261) );
  VHSR_MAOI222_2 U297 ( .A(n260), .B(n262), .C(n261), .ZN(n265) );
  VHSR_CLKNAND2_2 U298 ( .A1(b[4]), .A2(a[0]), .ZN(n447) );
  VHSR_NAND3_2 U299 ( .A1(a[1]), .A2(b[5]), .A3(n447), .ZN(n302) );
  VHSR_MAOI222_2 U300 ( .A(n304), .B(n303), .C(n302), .ZN(n301) );
  VHSR_IN_2 U301 ( .I(b[4]), .ZN(n350) );
  VHSR_IN_2 U302 ( .I(b[5]), .ZN(n353) );
  VHSR_IN_2 U303 ( .I(a[3]), .ZN(n384) );
  VHSR_IN_2 U304 ( .I(a[2]), .ZN(n366) );
  VHSR_NOR4_2 U305 ( .A1(n350), .A2(n353), .A3(n384), .A4(n366), .ZN(n270) );
  VHSR_AOI22_2 U306 ( .A1(b[4]), .A2(a[3]), .B1(b[5]), .B2(a[2]), .ZN(n256) );
  VHSR_NOR2_1 U307 ( .A1(n270), .A2(n256), .ZN(n259) );
  VHSR_IN_2 U308 ( .I(a[1]), .ZN(n453) );
  VHSR_NOR3_2 U309 ( .A1(n353), .A2(n453), .A3(n447), .ZN(n311) );
  VHSR_AOI22_2 U310 ( .A1(b[6]), .A2(a[1]), .B1(b[7]), .B2(a[0]), .ZN(n257) );
  VHSR_NOR2_1 U311 ( .A1(n272), .A2(n257), .ZN(n258) );
  VHSR_AND2_2 U312 ( .A1(n301), .A2(n298), .Z(n297) );
  VHSR_AD1_1 U313 ( .A(n259), .B(n311), .CI(n258), .CO(n289), .S(n298) );
  VHSR_NOR2_1 U314 ( .A1(n297), .A2(n289), .ZN(n292) );
  VHSR_IN_2 U315 ( .I(n260), .ZN(n277) );
  VHSR_CLKNAND2_2 U316 ( .A1(n262), .A2(n261), .ZN(n264) );
  VHSR_IN_2 U317 ( .I(n265), .ZN(n263) );
  VHSR_OAI21_2 U318 ( .A1(n277), .A2(n264), .B(n263), .ZN(n293) );
  VHSR_NOR2_1 U319 ( .A1(n292), .A2(n293), .ZN(n290) );
  VHSR_NOR2_1 U320 ( .A1(n265), .A2(n290), .ZN(n288) );
  VHSR_CLKNAND2_2 U321 ( .A1(b[7]), .A2(a[2]), .ZN(n267) );
  VHSR_AOI21_2 U322 ( .A1(b[6]), .A2(a[3]), .B(n267), .ZN(n266) );
  VHSR_AOI31_2 U323 ( .A1(b[6]), .A2(n267), .A3(a[3]), .B(n266), .ZN(n268) );
  VHSR_IN_2 U324 ( .I(n268), .ZN(n269) );
  VHSR_MAOI222_2 U325 ( .A(n272), .B(n270), .C(n269), .ZN(n273) );
  VHSR_OAI21_2 U326 ( .A1(n272), .A2(n271), .B(n273), .ZN(n287) );
  VHSR_NOR2_1 U327 ( .A1(n288), .A2(n287), .ZN(n286) );
  VHSR_OAI211_2 U328 ( .A1(n276), .A2(n277), .B(a[3]), .C(b[7]), .ZN(n274) );
  VHSR_IN_2 U329 ( .I(n274), .ZN(n338) );
  VHSR_CLKNAND2_2 U330 ( .A1(b[7]), .A2(a[3]), .ZN(n278) );
  VHSR_OAI21_2 U331 ( .A1(n278), .A2(n277), .B(n276), .ZN(n275) );
  VHSR_OAI31_2 U332 ( .A1(n278), .A2(n277), .A3(n276), .B(n275), .ZN(n346) );
  VHSR_AOI21_2 U333 ( .A1(n280), .A2(n279), .B(n339), .ZN(n345) );
  VHSR_OAI21_2 U334 ( .A1(n283), .A2(n282), .B(n281), .ZN(n284) );
  VHSR_XNOR2_2 U335 ( .A1(n285), .A2(n284), .ZN(n349) );
  VHSR_AOI21_2 U336 ( .A1(n288), .A2(n287), .B(n286), .ZN(n348) );
  VHSR_CLKNAND2_2 U337 ( .A1(n297), .A2(n289), .ZN(n291) );
  VHSR_AOI22_2 U338 ( .A1(n293), .A2(n292), .B1(n291), .B2(n290), .ZN(n358) );
  VHSR_AOI21_2 U339 ( .A1(n296), .A2(n295), .B(n294), .ZN(n357) );
  VHSR_IAO21_2 U340 ( .A1(n301), .A2(n298), .B(n297), .ZN(n361) );
  VHSR_AOI21_2 U341 ( .A1(n305), .A2(n300), .B(n299), .ZN(n360) );
  VHSR_AOI31_2 U342 ( .A1(n304), .A2(n303), .A3(n302), .B(n301), .ZN(n383) );
  VHSR_OAI31_2 U343 ( .A1(n308), .A2(n307), .A3(n306), .B(n305), .ZN(n309) );
  VHSR_IN_2 U344 ( .I(n309), .ZN(n382) );
  VHSR_AOI22_2 U345 ( .A1(b[4]), .A2(a[1]), .B1(b[5]), .B2(a[0]), .ZN(n310) );
  VHSR_NOR2_1 U346 ( .A1(n311), .A2(n310), .ZN(n397) );
  VHSR_CLKNAND2_2 U347 ( .A1(a[4]), .A2(b[4]), .ZN(n324) );
