...
module mul8_89 ( a, b, product );
  ...
  VHSR_INOR2_2 U204 ( .A1(n239), .B1(n223), .ZN(n225) );
  VHSR_NOR2_1 U205 ( .A1(n313), .A2(n307), .ZN(n261) );
  VHSR_INOR2_2 U206 ( .A1(n373), .B1(n278), .ZN(n282) );
  VHSR_INOR2_2 U207 ( .A1(n227), .B1(n250), .ZN(n249) );
  VHSR_INOR2_2 U208 ( .A1(n346), .B1(n345), .ZN(n358) );
  VHSR_INAND2_2 U209 ( .A1(n319), .B1(n336), .ZN(n334) );
  VHSR_NOR2_1 U210 ( .A1(n289), .A2(n293), .ZN(n288) );
  VHSR_NOR2_1 U211 ( .A1(n232), .A2(n231), .ZN(n291) );
  VHSR_IOA21_2 U212 ( .A1(n316), .A2(n315), .B(n314), .ZN(n400) );
  ...
  VHSR_IN_2 U230 ( .I(a[3]), .ZN(n321) );
  VHSR_IN_2 U231 ( .I(b[6]), .ZN(n275) );
  VHSR_IN_2 U232 ( .I(a[2]), .ZN(n317) );
  VHSR_OAI22_2 U233 ( .A1(n275), .A2(n321), .B1(n274), .B2(n317), .ZN(n237) );
  ...
  VHSR_IN_2 U240 ( .I(b[4]), .ZN(n339) );
  VHSR_IN_2 U241 ( .I(a[0]), .ZN(n398) );
  VHSR_OAI211_2 U242 ( .A1(n339), .A2(n398), .B(b[5]), .C(a[1]), .ZN(n256) );
  VHSR_CLKNAND2_2 U243 ( .A1(b[6]), .A2(a[0]), .ZN(n255) );
  VHSR_MAOI222_2 U244 ( .A(n257), .B(n256), .C(n255), .ZN(n254) );
  VHSR_NAND4_2 U245 ( .A1(b[4]), .A2(b[5]), .A3(a[2]), .A4(a[3]), .ZN(n234) );
  VHSR_IN_2 U246 ( .I(b[5]), .ZN(n305) );
  VHSR_OAI22_2 U247 ( .A1(n339), .A2(n321), .B1(n305), .B2(n317), .ZN(n214) );
  VHSR_AND2_2 U248 ( .A1(n234), .A2(n214), .Z(n217) );
  VHSR_OAI21_2 U249 ( .A1(n274), .A2(n398), .B(n215), .ZN(n216) );
  VHSR_IN_2 U250 ( .I(a[1]), .ZN(n396) );
  VHSR_NOR4_2 U251 ( .A1(n339), .A2(n305), .A3(n396), .A4(n398), .ZN(n264) );
  VHSR_AND2_2 U252 ( .A1(n254), .A2(n253), .Z(n252) );
  VHSR_AD1_1 U253 ( .A(n217), .B(n216), .CI(n264), .CO(n243), .S(n253) );
  VHSR_AOI21_2 U254 ( .A1(n219), .A2(n218), .B(n220), .ZN(n246) );
  VHSR_OAI32_2 U255 ( .A1(n220), .A2(n252), .A3(n243), .B1(n246), .B2(n220), 
        .ZN(n235) );
  VHSR_CLKNAND2_2 U256 ( .A1(n235), .A2(n234), .ZN(n233) );
  VHSR_CLKNAND2_2 U257 ( .A1(n237), .A2(n233), .ZN(n230) );
  VHSR_NOR3_2 U258 ( .A1(n274), .A2(n321), .A3(n230), .ZN(n292) );
  VHSR_CLKNAND2_2 U259 ( .A1(b[3]), .A2(a[7]), .ZN(n232) );
  VHSR_IN_2 U260 ( .I(b[3]), .ZN(n320) );
  VHSR_IN_2 U261 ( .I(a[6]), .ZN(n267) );
  VHSR_IN_2 U262 ( .I(a[7]), .ZN(n272) );
  VHSR_IN_2 U263 ( .I(b[2]), .ZN(n313) );
  VHSR_OAI22_2 U264 ( .A1(n320), .A2(n267), .B1(n272), .B2(n313), .ZN(n242) );
  ...
  VHSR_NOR2_1 U272 ( .A1(n267), .A2(n399), .ZN(n224) );
  VHSR_IN_2 U273 ( .I(b[0]), .ZN(n397) );
  VHSR_NOR4_2 U274 ( .A1(n307), .A2(n303), .A3(n399), .A4(n397), .ZN(n266) );
  VHSR_NAND3_2 U275 ( .A1(b[3]), .A2(n261), .A3(a[5]), .ZN(n239) );
  VHSR_AOI22_2 U276 ( .A1(b[3]), .A2(a[4]), .B1(b[2]), .B2(a[5]), .ZN(n223) );
  VHSR_MAOI222_2 U277 ( .A(n224), .B(n266), .C(n225), .ZN(n227) );
  VHSR_AOI211_2 U278 ( .A1(a[4]), .A2(b[0]), .B(n303), .C(n399), .ZN(n260) );
  VHSR_AOI21_2 U279 ( .A1(n272), .A2(n267), .B(n397), .ZN(n259) );
  VHSR_MAOI222_2 U280 ( .A(n261), .B(n260), .C(n259), .ZN(n258) );
  VHSR_OR2_2 U281 ( .A1(n266), .A2(n225), .Z(n226) );
  VHSR_AOI32_2 U282 ( .A1(b[1]), .A2(n227), .A3(a[6]), .B1(n226), .B2(n227), 
        .ZN(n251) );
  VHSR_NOR2_1 U283 ( .A1(n258), .A2(n251), .ZN(n250) );
  ...
  VHSR_OAI32_2 U288 ( .A1(n292), .A2(n321), .A3(n274), .B1(n230), .B2(n292), 
        .ZN(n299) );
  ...
  VHSR_NOR2_1 U294 ( .A1(n252), .A2(n243), .ZN(n245) );
  VHSR_AOI22_2 U295 ( .A1(n252), .A2(n243), .B1(n246), .B2(n245), .ZN(n244) );
  VHSR_OAI21_2 U296 ( .A1(n246), .A2(n245), .B(n244), .ZN(n310) );
  VHSR_AOI21_2 U297 ( .A1(n249), .A2(n248), .B(n247), .ZN(n309) );
  VHSR_AOI21_2 U298 ( .A1(n258), .A2(n251), .B(n250), .ZN(n325) );
  VHSR_IAO21_2 U299 ( .A1(n254), .A2(n253), .B(n252), .ZN(n324) );
  ...
  VHSR_NOR2_1 U345 ( .A1(n313), .A2(n317), .ZN(n332) );
  VHSR_IN_2 U346 ( .I(n332), .ZN(n322) );
  VHSR_NOR2_1 U347 ( .A1(n313), .A2(n321), .ZN(n312) );
  VHSR_OAI21_2 U348 ( .A1(n320), .A2(n317), .B(n312), .ZN(n311) );
  VHSR_OAI31_2 U349 ( .A1(n320), .A2(n312), .A3(n317), .B(n311), .ZN(n335) );
  VHSR_CLKNAND2_2 U350 ( .A1(b[3]), .A2(a[3]), .ZN(n331) );
  VHSR_CLKNAND2_2 U351 ( .A1(b[1]), .A2(a[1]), .ZN(n401) );
  VHSR_AOI22_2 U352 ( .A1(b[3]), .A2(a[1]), .B1(b[1]), .B2(a[3]), .ZN(n318) );
  VHSR_OAI22_2 U353 ( .A1(n331), .A2(n401), .B1(n322), .B2(n318), .ZN(n319) );
  VHSR_OAI22_2 U354 ( .A1(n320), .A2(n398), .B1(n313), .B2(n396), .ZN(n384) );
  VHSR_IN_2 U355 ( .I(n401), .ZN(n316) );
  VHSR_NOR2_1 U356 ( .A1(n397), .A2(n317), .ZN(n315) );
  VHSR_OAI211_2 U357 ( .A1(n315), .A2(n316), .B(b[2]), .C(a[0]), .ZN(n314) );
  VHSR_OAI22_2 U358 ( .A1(n399), .A2(n317), .B1(n397), .B2(n321), .ZN(n383) );
  VHSR_AOI21_2 U359 ( .A1(n318), .A2(n322), .B(n319), .ZN(n337) );
  VHSR_CLKNAND2_2 U360 ( .A1(n338), .A2(n337), .ZN(n336) );
  VHSR_CLKNAND2_2 U361 ( .A1(n335), .A2(n334), .ZN(n329) );
  VHSR_AOI211_2 U362 ( .A1(n322), .A2(n329), .B(n321), .C(n320), .ZN(n377) );
  VHSR_AD1_1 U363 ( .A(n325), .B(n324), .CI(n323), .CO(n308), .S(n376) );
  VHSR_AD1_1 U364 ( .A(n328), .B(n327), .CI(n326), .CO(n323), .S(n380) );
