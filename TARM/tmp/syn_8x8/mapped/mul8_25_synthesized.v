...
module mul8_25 ( a, b, product );
  ...
  VHSR_CLKNAND2_2 U349 ( .A1(b[2]), .A2(a[0]), .ZN(n412) );
  VHSR_NOR3_2 U350 ( .A1(n333), .A2(n407), .A3(n412), .ZN(n329) );
  VHSR_AOI22_2 U351 ( .A1(b[3]), .A2(a[0]), .B1(b[2]), .B2(a[1]), .ZN(n322) );
  VHSR_NOR2_1 U352 ( .A1(n329), .A2(n322), .ZN(n389) );
  VHSR_NOR4_2 U353 ( .A1(n410), .A2(n408), .A3(n332), .A4(n330), .ZN(n328) );
  VHSR_CLKNAND2_2 U354 ( .A1(b[0]), .A2(a[3]), .ZN(n323) );
  VHSR_OAI32_2 U355 ( .A1(n328), .A2(n332), .A3(n410), .B1(n323), .B2(n328), 
        .ZN(n388) );
  VHSR_AOI22_2 U356 ( .A1(b[1]), .A2(a[1]), .B1(b[0]), .B2(a[2]), .ZN(n413) );
  VHSR_NOR2_1 U357 ( .A1(n413), .A2(n412), .ZN(n411) );
  VHSR_OAI211_2 U358 ( .A1(n332), .A2(n408), .B(b[1]), .C(a[3]), .ZN(n326) );
  VHSR_NAND3_2 U359 ( .A1(a[1]), .A2(b[3]), .A3(n412), .ZN(n324) );
  VHSR_IN_2 U360 ( .I(n342), .ZN(n335) );
  VHSR_AND2_2 U361 ( .A1(n324), .A2(n335), .Z(n325) );
  VHSR_MAOI222_2 U362 ( .A(n326), .B(n335), .C(n324), .ZN(n327) );
  VHSR_AOI21_2 U363 ( .A1(n326), .A2(n325), .B(n327), .ZN(n344) );
  VHSR_AOI21_2 U364 ( .A1(n345), .A2(n344), .B(n327), .ZN(n351) );
  VHSR_NOR2_1 U365 ( .A1(n329), .A2(n328), .ZN(n350) );
  VHSR_CLKNAND2_2 U366 ( .A1(b[3]), .A2(a[3]), .ZN(n343) );
  VHSR_OAI22_2 U367 ( .A1(n333), .A2(n332), .B1(n331), .B2(n330), .ZN(n334) );
  VHSR_OAI21_2 U368 ( .A1(n343), .A2(n335), .B(n334), .ZN(n349) );
  VHSR_AOI21_2 U369 ( .A1(n339), .A2(n335), .B(n343), .ZN(n384) );
  VHSR_AD1_1 U370 ( .A(n338), .B(n337), .CI(n336), .CO(n319), .S(n392) );
  VHSR_IN_2 U371 ( .I(n339), .ZN(n341) );
  VHSR_OAI21_2 U372 ( .A1(n343), .A2(n342), .B(n341), .ZN(n340) );
  VHSR_OAI31_2 U373 ( .A1(n343), .A2(n342), .A3(n341), .B(n340), .ZN(n391) );
  VHSR_XNOR2_2 U374 ( .A1(n345), .A2(n344), .ZN(n406) );
  VHSR_NOR2_1 U375 ( .A1(n346), .A2(n409), .ZN(n347) );
  VHSR_AOI32_2 U376 ( .A1(b[0]), .A2(n348), .A3(a[4]), .B1(n347), .B2(n348), 
        .ZN(n405) );
  VHSR_AD1_1 U377 ( .A(n351), .B(n350), .CI(n349), .CO(n339), .S(n352) );
  VHSR_IN_2 U378 ( .I(n352), .ZN(n387) );
  VHSR_AD1_1 U379 ( .A(n355), .B(n354), .CI(n353), .CO(n336), .S(n386) );
  VHSR_CLKNAND2_2 U380 ( .A1(a[7]), .A2(b[6]), .ZN(n359) );
  VHSR_AOI21_2 U381 ( .A1(a[6]), .A2(b[7]), .B(n359), .ZN(n358) );
  VHSR_AOI31_2 U382 ( .A1(a[6]), .A2(n359), .A3(b[7]), .B(n358), .ZN(n360) );
  VHSR_IN_2 U383 ( .I(n360), .ZN(n361) );
  VHSR_MAOI222_2 U384 ( .A(n364), .B(n362), .C(n361), .ZN(n371) );
  VHSR_OAI21_2 U385 ( .A1(n364), .A2(n363), .B(n371), .ZN(n368) );
  VHSR_CLKXOR2_2 U386 ( .A1(n369), .A2(n368), .Z(n365) );
  VHSR_CLKNAND2_2 U387 ( .A1(n366), .A2(n365), .ZN(n401) );
  VHSR_OAI21_2 U388 ( .A1(n366), .A2(n365), .B(n401), .ZN(n367) );
  VHSR_CLKNAND2_2 U389 ( .A1(a[7]), .A2(b[7]), .ZN(n400) );
  VHSR_NOR2_1 U390 ( .A1(n369), .A2(n368), .ZN(n370) );
  VHSR_AND3_2 U391 ( .A1(n402), .A2(n372), .A3(n401), .Z(n373) );
  VHSR_NOR2_1 U392 ( .A1(n400), .A2(n373), .ZN(product[15]) );
  VHSR_AD1_1 U393 ( .A(n392), .B(n391), .CI(n390), .CO(n383), .S(product[6])
         );
  VHSR_AD1_1 U394 ( .A(n395), .B(n394), .CI(n393), .CO(n396), .S(product[11])
         );
  VHSR_AD1_1 U395 ( .A(n398), .B(n397), .CI(n396), .CO(n366), .S(
        \intadd_0/SUM[7] ) );
  VHSR_NOR2_1 U396 ( .A1(n400), .A2(n399), .ZN(n403) );
  VHSR_XOR3_2 U397 ( .A1(n403), .A2(n402), .A3(n401), .Z(product[14]) );
  VHSR_AOI21_2 U398 ( .A1(n406), .A2(n405), .B(n404), .ZN(product[4]) );
  VHSR_OAI22_2 U399 ( .A1(n410), .A2(n409), .B1(n408), .B2(n407), .ZN(
        product[1]) );
  VHSR_AOI21_2 U400 ( .A1(n413), .A2(n412), .B(n411), .ZN(product[2]) );
endmodule
