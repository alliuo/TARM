...
module mul8_104 ( a, b, product );
  ...
  VHSR_CLKNAND2_2 U356 ( .A1(b[2]), .A2(a[0]), .ZN(n421) );
  VHSR_NOR3_2 U357 ( .A1(n342), .A2(n416), .A3(n421), .ZN(n338) );
  VHSR_AOI22_2 U358 ( .A1(b[3]), .A2(a[0]), .B1(b[2]), .B2(a[1]), .ZN(n331) );
  VHSR_NOR2_1 U359 ( .A1(n338), .A2(n331), .ZN(n401) );
  VHSR_IN_2 U360 ( .I(a[2]), .ZN(n341) );
  VHSR_NOR4_2 U361 ( .A1(n419), .A2(n417), .A3(n341), .A4(n339), .ZN(n337) );
  VHSR_CLKNAND2_2 U362 ( .A1(b[0]), .A2(a[3]), .ZN(n332) );
  VHSR_OAI32_2 U363 ( .A1(n337), .A2(n341), .A3(n419), .B1(n332), .B2(n337), 
        .ZN(n400) );
  VHSR_AOI22_2 U364 ( .A1(b[1]), .A2(a[1]), .B1(b[0]), .B2(a[2]), .ZN(n422) );
  VHSR_NOR2_1 U365 ( .A1(n422), .A2(n421), .ZN(n420) );
  VHSR_OAI211_2 U366 ( .A1(n341), .A2(n417), .B(b[1]), .C(a[3]), .ZN(n335) );
  VHSR_NAND3_2 U367 ( .A1(a[1]), .A2(b[3]), .A3(n421), .ZN(n333) );
  VHSR_IN_2 U368 ( .I(n351), .ZN(n344) );
  VHSR_AND2_2 U369 ( .A1(n333), .A2(n344), .Z(n334) );
  VHSR_MAOI222_2 U370 ( .A(n335), .B(n344), .C(n333), .ZN(n336) );
  VHSR_AOI21_2 U371 ( .A1(n335), .A2(n334), .B(n336), .ZN(n353) );
  VHSR_AOI21_2 U372 ( .A1(n354), .A2(n353), .B(n336), .ZN(n360) );
  VHSR_NOR2_1 U373 ( .A1(n338), .A2(n337), .ZN(n359) );
  VHSR_CLKNAND2_2 U374 ( .A1(b[3]), .A2(a[3]), .ZN(n352) );
  VHSR_OAI22_2 U375 ( .A1(n342), .A2(n341), .B1(n340), .B2(n339), .ZN(n343) );
  VHSR_OAI21_2 U376 ( .A1(n352), .A2(n344), .B(n343), .ZN(n358) );
  VHSR_AOI21_2 U377 ( .A1(n348), .A2(n344), .B(n352), .ZN(n396) );
  VHSR_AD1_1 U378 ( .A(n347), .B(n346), .CI(n345), .CO(n328), .S(n404) );
  VHSR_IN_2 U379 ( .I(n348), .ZN(n350) );
  VHSR_OAI21_2 U380 ( .A1(n352), .A2(n351), .B(n350), .ZN(n349) );
  VHSR_OAI31_2 U381 ( .A1(n352), .A2(n351), .A3(n350), .B(n349), .ZN(n403) );
  VHSR_XNOR2_2 U382 ( .A1(n354), .A2(n353), .ZN(n415) );
  VHSR_NOR2_1 U383 ( .A1(n355), .A2(n418), .ZN(n356) );
  VHSR_AOI32_2 U384 ( .A1(b[0]), .A2(n357), .A3(a[4]), .B1(n356), .B2(n357), 
        .ZN(n414) );
  VHSR_AD1_1 U385 ( .A(n360), .B(n359), .CI(n358), .CO(n348), .S(n361) );
  VHSR_IN_2 U386 ( .I(n361), .ZN(n399) );
  VHSR_AD1_1 U387 ( .A(n364), .B(n363), .CI(n362), .CO(n345), .S(n398) );
  VHSR_CLKNAND2_2 U388 ( .A1(a[7]), .A2(b[6]), .ZN(n368) );
  VHSR_AOI21_2 U389 ( .A1(a[6]), .A2(b[7]), .B(n368), .ZN(n367) );
  VHSR_AOI31_2 U390 ( .A1(a[6]), .A2(n368), .A3(b[7]), .B(n367), .ZN(n369) );
  VHSR_IN_2 U391 ( .I(n369), .ZN(n370) );
  VHSR_MAOI222_2 U392 ( .A(n373), .B(n371), .C(n370), .ZN(n380) );
  VHSR_OAI21_2 U393 ( .A1(n373), .A2(n372), .B(n380), .ZN(n377) );
  VHSR_CLKXOR2_2 U394 ( .A1(n378), .A2(n377), .Z(n374) );
  VHSR_CLKNAND2_2 U395 ( .A1(n375), .A2(n374), .ZN(n410) );
  VHSR_OAI21_2 U396 ( .A1(n375), .A2(n374), .B(n410), .ZN(n376) );
  VHSR_CLKNAND2_2 U397 ( .A1(a[7]), .A2(b[7]), .ZN(n409) );
  VHSR_NOR2_1 U398 ( .A1(n378), .A2(n377), .ZN(n379) );
  VHSR_AND3_2 U399 ( .A1(n411), .A2(n381), .A3(n410), .Z(n382) );
  VHSR_NOR2_1 U400 ( .A1(n409), .A2(n382), .ZN(product[15]) );
  VHSR_AD1_1 U401 ( .A(n404), .B(n403), .CI(n402), .CO(n395), .S(product[6])
         );
  VHSR_AD1_1 U402 ( .A(n407), .B(n406), .CI(n405), .CO(n375), .S(
        \intadd_0/SUM[7] ) );
  VHSR_NOR2_1 U403 ( .A1(n409), .A2(n408), .ZN(n412) );
  VHSR_XOR3_2 U404 ( .A1(n412), .A2(n411), .A3(n410), .Z(product[14]) );
  VHSR_AOI21_2 U405 ( .A1(n415), .A2(n414), .B(n413), .ZN(product[4]) );
  VHSR_OAI22_2 U406 ( .A1(n419), .A2(n418), .B1(n417), .B2(n416), .ZN(
        product[1]) );
  VHSR_AOI21_2 U407 ( .A1(n422), .A2(n421), .B(n420), .ZN(product[2]) );
endmodule
