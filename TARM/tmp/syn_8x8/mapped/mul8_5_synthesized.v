...
module mul8_5 ( a, b, product );
  ...
  VHSR_INOR2_2 U206 ( .A1(n239), .B1(n223), .ZN(n225) );
  VHSR_NOR2_1 U207 ( .A1(n305), .A2(n317), .ZN(n258) );
  ...
  VHSR_NOR2_1 U211 ( .A1(n343), .A2(n305), .ZN(n374) );
  ...
  VHSR_IN_2 U233 ( .I(b[5]), .ZN(n306) );
  VHSR_AOI211_2 U234 ( .A1(b[4]), .A2(a[2]), .B(n306), .C(n321), .ZN(n219) );
  VHSR_OAI22_2 U235 ( .A1(n274), .A2(n319), .B1(n270), .B2(n397), .ZN(n218) );
  VHSR_AOI22_2 U236 ( .A1(n214), .A2(n213), .B1(n219), .B2(n218), .ZN(n220) );
  VHSR_CLKNAND2_2 U237 ( .A1(b[4]), .A2(a[2]), .ZN(n263) );
  VHSR_CLKNAND2_2 U238 ( .A1(b[6]), .A2(a[0]), .ZN(n262) );
  VHSR_IN_2 U239 ( .I(b[4]), .ZN(n343) );
  VHSR_IN_2 U240 ( .I(a[0]), .ZN(n399) );
  VHSR_OAI211_2 U241 ( .A1(n343), .A2(n399), .B(b[5]), .C(a[1]), .ZN(n261) );
  VHSR_MAOI222_2 U242 ( .A(n263), .B(n262), .C(n261), .ZN(n260) );
  VHSR_NAND4_2 U243 ( .A1(b[4]), .A2(b[5]), .A3(a[2]), .A4(a[3]), .ZN(n234) );
  VHSR_OAI22_2 U244 ( .A1(n343), .A2(n321), .B1(n306), .B2(n319), .ZN(n215) );
  VHSR_AND2_2 U245 ( .A1(n234), .A2(n215), .Z(n217) );
  VHSR_OAI22_2 U246 ( .A1(n274), .A2(n397), .B1(n270), .B2(n399), .ZN(n216) );
  VHSR_NOR4_2 U247 ( .A1(n343), .A2(n306), .A3(n397), .A4(n399), .ZN(n267) );
  VHSR_AND2_2 U248 ( .A1(n260), .A2(n254), .Z(n253) );
  ...
  VHSR_IN_2 U262 ( .I(a[4]), .ZN(n305) );
  VHSR_CLKNAND2_2 U263 ( .A1(a[5]), .A2(b[3]), .ZN(n221) );
  VHSR_IN_2 U264 ( .I(b[1]), .ZN(n400) );
  VHSR_OAI22_2 U265 ( .A1(n258), .A2(n221), .B1(n268), .B2(n400), .ZN(n228) );
  VHSR_IN_2 U266 ( .I(a[5]), .ZN(n308) );
  VHSR_NOR4_2 U267 ( .A1(n258), .A2(n232), .A3(n308), .A4(n400), .ZN(n222) );
  VHSR_AOI31_2 U268 ( .A1(b[2]), .A2(a[6]), .A3(n228), .B(n222), .ZN(n229) );
  VHSR_NOR2_1 U269 ( .A1(n273), .A2(n400), .ZN(n224) );
  VHSR_IN_2 U270 ( .I(b[0]), .ZN(n398) );
  VHSR_NOR4_2 U271 ( .A1(n305), .A2(n308), .A3(n400), .A4(n398), .ZN(n265) );
  VHSR_NAND3_2 U272 ( .A1(a[5]), .A2(b[3]), .A3(n258), .ZN(n239) );
  VHSR_AOI22_2 U273 ( .A1(a[4]), .A2(b[3]), .B1(a[5]), .B2(b[2]), .ZN(n223) );
  VHSR_MAOI222_2 U274 ( .A(n224), .B(n265), .C(n225), .ZN(n227) );
  VHSR_AOI211_2 U275 ( .A1(a[4]), .A2(b[0]), .B(n308), .C(n400), .ZN(n257) );
  VHSR_AOI21_2 U276 ( .A1(n273), .A2(n268), .B(n398), .ZN(n256) );
  VHSR_MAOI222_2 U277 ( .A(n258), .B(n257), .C(n256), .ZN(n255) );
  VHSR_OR2_2 U278 ( .A1(n265), .A2(n225), .Z(n226) );
  VHSR_AOI32_2 U279 ( .A1(b[1]), .A2(n227), .A3(a[6]), .B1(n226), .B2(n227), 
        .ZN(n252) );
  VHSR_NOR2_1 U280 ( .A1(n255), .A2(n252), .ZN(n251) );
  ...
  VHSR_AOI21_2 U294 ( .A1(n255), .A2(n252), .B(n251), .ZN(n327) );
  VHSR_IAO21_2 U295 ( .A1(n260), .A2(n254), .B(n253), .ZN(n326) );
  VHSR_OAI31_2 U296 ( .A1(n258), .A2(n257), .A3(n256), .B(n255), .ZN(n259) );
  VHSR_IN_2 U297 ( .I(n259), .ZN(n333) );
  VHSR_AOI31_2 U298 ( .A1(n263), .A2(n262), .A3(n261), .B(n260), .ZN(n332) );
  VHSR_CLKNAND2_2 U299 ( .A1(a[5]), .A2(b[0]), .ZN(n264) );
  VHSR_OAI32_2 U300 ( .A1(n265), .A2(n400), .A3(n305), .B1(n264), .B2(n265), 
        .ZN(n336) );
  ...
  VHSR_OAI32_2 U305 ( .A1(n267), .A2(n397), .A3(n343), .B1(n266), .B2(n267), 
        .ZN(n334) );
  VHSR_AOI22_2 U306 ( .A1(b[4]), .A2(a[7]), .B1(a[6]), .B2(b[5]), .ZN(n269) );
  VHSR_NOR4_2 U307 ( .A1(n343), .A2(n273), .A3(n306), .A4(n268), .ZN(n354) );
  ...
  VHSR_NOR4_2 U312 ( .A1(n305), .A2(n274), .A3(n308), .A4(n270), .ZN(n352) );
  VHSR_NOR2_1 U313 ( .A1(n271), .A2(n352), .ZN(n275) );
  VHSR_MAOI222_2 U314 ( .A(n276), .B(n272), .C(n275), .ZN(n280) );
  VHSR_NOR2_1 U315 ( .A1(n343), .A2(n273), .ZN(n282) );
  VHSR_NOR2_1 U316 ( .A1(n305), .A2(n274), .ZN(n284) );
  ...
  VHSR_NOR2_1 U342 ( .A1(n306), .A2(n305), .ZN(n309) );
  VHSR_OAI21_2 U343 ( .A1(n343), .A2(n308), .B(n309), .ZN(n307) );
  VHSR_OAI31_2 U344 ( .A1(n343), .A2(n309), .A3(n308), .B(n307), .ZN(n371) );
  ...
  VHSR_NOR2_1 U375 ( .A1(n343), .A2(n399), .ZN(n344) );
  VHSR_AOI32_2 U376 ( .A1(b[0]), .A2(n345), .A3(a[4]), .B1(n344), .B2(n345), 
        .ZN(n395) );
